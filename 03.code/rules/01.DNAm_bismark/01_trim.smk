rule trim_galore:
    ...
    resources:
        ...
        runtime = 1440
    conda:
        "03.code/envs/qc.yaml"
    shell:
        "bash /data/home/quj_lab/zhangyuxin/01-project/001.meth/03.code/scripts/01.DNAm_bismark/01_trim.sh "
        "{input.raw_dir} {wildcards.sample} "
        "{config[paths][trim_dir]} "
        "{threads} {params.length} {params.quality} {params.logdir}"