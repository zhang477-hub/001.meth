rule dedup_unique:
    ...
    shell:
      "source /data/home/quj_lab/zhangyuxin/anaconda3/etc/profile.d/conda.sh && conda run -n wgbs bash /data/home/quj_lab/zhangyuxin/01-project/001.meth/03.code/scripts/01.DNAm_bismark/03_unique.sh {config[paths][map_dir]} {wildcards.sample} {config[paths][unique_dir]} {threads} {params.logdir}"